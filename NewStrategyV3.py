...
GoldHistoryV3=candlestick.GetEODDataFromMCX(Symbol,"C",3)
GoldHistoryV4=candlestick.GetEODDataFromMCX(Symbol,"C",4)
...
SilverHistory=candlestick.GetEODDataFromMCX(Symbol,PivotType,OHLC)
SilverHistoryV2=candlestick.GetEODDataFromMCX(Symbol,PivotType,3)
